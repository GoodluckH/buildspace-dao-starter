...
const tokenModule = sdk.getTokenModule("0x71F888421EbAd19ab1283dA6E6a4e7cbbc9a8C78")
const voteModule = sdk.getVoteModule(
  "0x5aB6f3E085ABc7809e087bd6050977C8421a9097",
);
...
const memberList = useMemo(() => {
  ...
  if (hasClaimedNFT) {
    return (
      ...
      <p>Congratulations on being a mealqlub member</p>
      <div>
        <div>
          <h2>Member List</h2>
